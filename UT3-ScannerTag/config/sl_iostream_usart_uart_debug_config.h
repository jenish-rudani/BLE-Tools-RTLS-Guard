...
#ifndef SL_IOSTREAM_USART_UART_DEBUG_CONFIG_H
#define SL_IOSTREAM_USART_UART_DEBUG_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>USART settings

// <o SL_IOSTREAM_USART_UART_DEBUG_BAUDRATE> Baud rate
// <i> Default: 115200
#define SL_IOSTREAM_USART_UART_DEBUG_BAUDRATE              115200

// <o SL_IOSTREAM_USART_UART_DEBUG_PARITY> Parity mode to use
// <usartNoParity=> No Parity
// <usartEvenParity=> Even parity
// <usartOddParity=> Odd parity
// <i> Default: usartNoParity
#define SL_IOSTREAM_USART_UART_DEBUG_PARITY                usartNoParity

// <o SL_IOSTREAM_USART_UART_DEBUG_STOP_BITS> Number of stop bits to use.
...
#define SL_IOSTREAM_USART_UART_DEBUG_STOP_BITS             usartStopbits1

// <o SL_IOSTREAM_USART_UART_DEBUG_FLOW_CONTROL_TYPE> Flow control
...
#define SL_IOSTREAM_USART_UART_DEBUG_FLOW_CONTROL_TYPE     usartHwFlowControlNone

// <o SL_IOSTREAM_USART_UART_DEBUG_RX_BUFFER_SIZE> Receive buffer size
// <i> Default: 32
#define SL_IOSTREAM_USART_UART_DEBUG_RX_BUFFER_SIZE    32

// <q SL_IOSTREAM_USART_UART_DEBUG_CONVERT_BY_DEFAULT_LF_TO_CRLF> Convert \n to \r\n
// <i> It can be changed at runtime using the C API.
// <i> Default: 0
#define SL_IOSTREAM_USART_UART_DEBUG_CONVERT_BY_DEFAULT_LF_TO_CRLF     1

// <q SL_IOSTREAM_USART_UART_DEBUG_RESTRICT_ENERGY_MODE_TO_ALLOW_RECEPTION> Restrict the energy mode to allow the reception.
// <i> Default: 1
...
// <<< sl:start pin_tool >>>
// <usart signal=TX,RX,(CTS),(RTS)> SL_IOSTREAM_USART_UART_DEBUG
