...
#ifndef SL_SPIDRV_AS39_SPI_CONFIG_H
#define SL_SPIDRV_AS39_SPI_CONFIG_H
...
// <o SL_SPIDRV_AS39_SPI_BITRATE> SPI bitrate
// <i> Default: 1000000
#define SL_SPIDRV_AS39_SPI_BITRATE           1000000

// <o SL_SPIDRV_AS39_SPI_FRAME_LENGTH> SPI frame length <4-16>
// <i> Default: 8
#define SL_SPIDRV_AS39_SPI_FRAME_LENGTH      8

// <o SL_SPIDRV_AS39_SPI_TYPE> SPI mode
// <spidrvMaster=> Master
// <spidrvSlave=> Slave
#define SL_SPIDRV_AS39_SPI_TYPE              spidrvMaster

// <o SL_SPIDRV_AS39_SPI_BIT_ORDER> Bit order on the SPI bus
// <spidrvBitOrderLsbFirst=> LSB transmitted first
// <spidrvBitOrderMsbFirst=> MSB transmitted first
#define SL_SPIDRV_AS39_SPI_BIT_ORDER         spidrvBitOrderMsbFirst

// <o SL_SPIDRV_AS39_SPI_CLOCK_MODE> SPI clock mode
...
#define SL_SPIDRV_AS39_SPI_CS_CONTROL        spidrvCsControlAuto

// <o SL_SPIDRV_AS39_SPI_SLAVE_START_MODE> SPI slave transfer start scheme
...
#define SL_SPIDRV_AS39_SPI_SLAVE_START_MODE  spidrvSlaveStartImmediate
// </h>
// <<< end of configuration section >>>

// <<< sl:start pin_tool >>>
// <usart signal=TX,RX,CLK,(CS)> SL_SPIDRV_AS39_SPI
