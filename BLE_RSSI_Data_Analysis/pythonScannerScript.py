...
dataFileName = "./1meterReadingsHolyIoT.csv"
measuredPower = -41
distanceList = ['3to0', '0to3']
orientationList = [0, 90, 180, 270]


def saveDataToFile(distance, orientation, rssiArray):
...
def startScanning():
  ################################
  print("Starting Scan")
  mySniffer = serial.Serial("COM3", 115200)
  ...
  for distance in distanceList:
    for orientation in orientationList:
      ...
      while scanCount > 0:
        ...
        scanCount -= 1
      saveDataToFile(distance, orientation, rssiArray)
